...
@Getter
@Setter
public class Code implements BaseEntity, Serializable {
  private Long id;
  ...
  public enum Column {
    id("code_id", "id", "BIGINT", false),
    categoryCode("category_code", "categoryCode", "VARCHAR", false),
    codeValue("code_value", "codeValue", "VARCHAR", false),
    codeName("code_name", "codeName", "VARCHAR", false),
    codeAlias("code_alias", "codeAlias", "VARCHAR", false),
    displayOrder("display_order", "displayOrder", "INTEGER", false),
    isInvalid("is_invalid", "isInvalid", "BIT", false),
