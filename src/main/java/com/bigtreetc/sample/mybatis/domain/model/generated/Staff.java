...
public class Staff implements BaseEntity, Serializable {
  ...
  public enum Column {
    ...
    passwordResetToken("password_reset_token", "passwordResetToken", "VARCHAR", false),
    tokenExpiresAt("token_expires_at", "tokenExpiresAt", "TIMESTAMP", false),
