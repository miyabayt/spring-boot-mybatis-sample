...
@Getter
@Setter
public class MailTemplate implements BaseEntity, Serializable {
  private Long id;
  ...
  public enum Column {
    id("mail_template_id", "id", "BIGINT", false),
    templateCode("template_code", "templateCode", "VARCHAR", false),
    ...
    templateBody("template_body", "templateBody", "LONGVARCHAR", false);
