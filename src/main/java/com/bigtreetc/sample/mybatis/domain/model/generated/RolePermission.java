...
@Getter
@Setter
public class RolePermission implements BaseEntity, Serializable {
  private Long id;
  ...
  public enum Column {
    id("role_permission_id", "id", "BIGINT", false),
    roleCode("role_code", "roleCode", "VARCHAR", false),
    permissionCode("permission_code", "permissionCode", "VARCHAR", false),
